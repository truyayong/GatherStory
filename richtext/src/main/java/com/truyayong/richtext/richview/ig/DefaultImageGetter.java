...
import com.truyayong.richtext.R;
import com.truyayong.richtext.richview.CacheType;
...
import com.truyayong.richtext.richview.ext.Base64;
...
public class DefaultImageGetter implements ImageGetter, ImageLoadNotify {
    ...
    private static final int TASK_TAG = R.id.tru_default_image_tag_id;//R.id.zhou_default_image_tag_id;
    ...
    @Override
    public Drawable getDrawable(final ImageHolder holder, final RichViewConfig config, final TextView textView) {
