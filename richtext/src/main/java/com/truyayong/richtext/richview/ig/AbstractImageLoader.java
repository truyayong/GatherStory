...
abstract class AbstractImageLoader implements ImageLoader {
    ...
    AbstractImageLoader(ImageHolder holder, RichViewConfig config, TextView textView, DrawableWrapper drawableWrapper, ImageLoadNotify iln) {
        this.holder = holder;
        this.config = config;
